...
func Push(w http.ResponseWriter, r *http.Request) {
	...
	for serverId, keys = range subKeys {
		if err = mpushKafka(serverId, keys, bodyBytes, define.OP_BRAOADCAST_USER_EVENT_REPLY, 1, define.PROTO_VER); err != nil {
			res["ret"] = InternalErr
			return
		}
	}
...
func PushAll(w http.ResponseWriter, r *http.Request) {
	...
	body = string(bodyBytes)
	// push all
	if err := broadcastKafka(bodyBytes, 1, 1, define.PROTO_VER); err != nil {
