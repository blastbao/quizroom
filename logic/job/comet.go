...
func mPushComet(serverId int32, subKeys []string, body json.RawMessage, op int32) {
...
func broadcast(msg []byte, op int32, ver int16) {
	var args = proto.BoardcastArg{
		P: proto.Proto{Ver: ver, Operation: op, Body: msg},
	}
